<nav x-data="{ open: false, isDark: document.documentElement.classList.contains('dark') }" class="bg-white dark:bg-dark-surface border-b border-gray-200 dark:border-dark-border transition-colors duration-200">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:flex">
                    ...
                    <x-nav-link :href="route('configurators.index')" :active="request()->routeIs('configurators.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('configurators.index')" :active="request()->routeIs('configurators.*')">
                {{ __('Configurators') }}
            </x-responsive-nav-link>
        </div>
