...
3. Set up your environment variables:
   ...
   ```ini
    DATABASE_URL="postgresql://postgres.[REF]:[PASS]@aws-1-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=3&pool_timeout=30&connect_timeout=30"
