...
5. In the **Configure Project** step:
   ...
   - Open the **Environment Variables** section and add:
     - `DATABASE_URL` = (e.g., `postgresql://postgres.xxx:pass@aws-1-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=10&connect_timeout=30`)
