...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex justify-between items-center w-full">
            <div class="flex items-center gap-3">
                ...
                <h2 class="font-semibold text-xl text-gray-900 dark:text-gray-100 leading-tight m-0">
                    <?php echo e(__('Configurators')); ?>

                </h2>
            </div>
            <div class="p-1.5 bg-primary-soft dark:bg-primary-darkSoft rounded-xl inline-block">
                <a href="<?php echo e(route('configurators.create')); ?>" class="inline-flex items-center justify-center px-6 py-2.5 bg-primary-DEFAULT hover:bg-primary-hover active:bg-primary-active border border-transparent rounded-lg font-semibold text-black dark:text-white focus:outline-none shadow-sm text-sm transition-colors">
    ...
    <div class="py-12">
        <div class="max-w-[1280px] mx-auto px-6 space-y-6">
            ...
            <?php $__currentLoopData = $configurators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $configurator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- Configurator Card -->
            <div class="bg-white dark:bg-dark-surface2 shadow-sm rounded-lg border border-gray-200 dark:border-dark-border transition-all duration-300"
                 x-data="pcBuilder(<?php echo e(Js::from($allProductsByCategory)); ?>, <?php echo e(Js::from($configurator->products)); ?>, '<?php echo e($configurator->id); ?>')">
                ...
                <div class="p-6 border-b border-gray-200 dark:border-dark-border flex flex-col md:flex-row justify-between items-start md:items-center bg-gray-50/50 dark:bg-dark-surface rounded-t-lg">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="p-1 bg-primary-soft dark:bg-primary-darkSoft rounded-lg inline-block">
                            <a href="<?php echo e(route('configurators.edit', $configurator)); ?>" class="inline-flex items-center justify-center px-4 py-1.5 bg-primary-DEFAULT hover:bg-primary-hover active:bg-primary-active text-black dark:text-white font-semibold rounded-md shadow-sm text-xs transition-colors">Edit Details</a>
                        </div>
            ...
            <div class="mt-4">
                <?php echo e($configurators->links()); ?>
...
<?php endif; ?><?php /**PATH /Users/flo/cms/resources/views/configurators/index.blade.php ENDPATH**/ ?>