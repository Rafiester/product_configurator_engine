            ...
            <div class="bg-white dark:bg-dark-surface p-4 shadow-sm rounded-xl mb-6 border border-gray-200 dark:border-dark-border">
                ...
                <form method="GET" action="<?php echo e(route('products.index')); ?>" class="flex flex-row items-center gap-4 w-full">
                    ...
                    <div class="flex items-center space-x-3 flex-none ml-2">
                        ...
                        <div class="p-1.5 bg-primary-soft dark:bg-primary-darkSoft rounded-xl inline-block">
                            <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center justify-center px-6 py-2 bg-primary-DEFAULT hover:bg-primary-hover active:bg-primary-active text-black dark:text-white font-semibold rounded-lg shadow-sm sm:text-sm whitespace-nowrap transition-colors focus:outline-none">
                                Clear
                            </a>
                        </div>
                    </div>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-3">
                                        <div class="p-1 bg-primary-soft dark:bg-primary-darkSoft rounded-lg inline-block">
                                            <a href="<?php echo e(route('products.edit', $product)); ?>" class="inline-flex items-center justify-center px-4 py-1.5 bg-primary-DEFAULT hover:bg-primary-hover active:bg-primary-active text-black dark:text-white font-semibold rounded-md shadow-sm text-xs transition-colors">Edit</a>
                                        </div>
