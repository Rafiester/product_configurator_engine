...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-primary-DEFAULT shadow-sm focus:ring-primary-DEFAULT" name="remember">
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-DEFAULT" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/flo/cms/resources/views/auth/login.blade.php ENDPATH**/ ?>